    ...
    return (
        ...
        <Box>
            ...
            <Box sx={{ paddingTop: '100px' }}>
                <Typography sx={{ ml: 66, border: '1px solid', borderRadius: '100px', fontFamily: 'inherit', fontWeight: '500', width: '200px', padding: '4px', textAlign: 'center' }}>
                    ABOUT OUR COMPANY
                </Typography>
                <Typography sx={{ textAlign: 'center', lineHeight: '66px', paddingTop: '30px', fontSize: '55px', fontWeight: '500' }}>
                    Welcome to Resonance
                    <br /> Creative Studio
                </Typography>
                <Typography sx={{ textAlign: "center", fontSize: '22px', fontWeight: '500', paddingTop: '20px', color: '#757575' }}>
                    We are a full-service creative studio creating <br /> beautiful digital experiences and products.
                </Typography>
                <Typography sx={{ paddingTop: '80px', ml: 10 }}>
                    <img style={{ width: '90%', height: '100%' }} src="	https://resonance-react-app.netlify.app/assets/images/about-image-1.jpg" alt="" />
                </Typography>
            </Box>
